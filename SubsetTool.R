...
GaugeNumbers <- read.csv(file="c:/Users/joel/Documents/RiverDischargeProject/MasterTables/Dates/L7AllReturn.csv", sep=",",header=TRUE)

#load master tables
DischargeValues = read.csv(file="c:/Users/joel/Documents/RiverDischargeProject/MasterTables/DischargeValues.csv", sep=",",header=TRUE)
DischargeDates = read.csv(file="c:/Users/joel/Documents/RiverDischargeProject/MasterTables/DischargeDates.csv", sep=",",header=TRUE)
DischargeCodes = read.csv(file="c:/Users/joel/Documents/RiverDischargeProject/MasterTables/DischargeCodes.csv", sep=",",header=TRUE)
...
write.csv(SatQDates,"DischargeDates_Landsat7_AllReturns.csv",row.names = FALSE)
write.csv(SatQValues,"DischargeValues_Landsat7_AllReturns.csv",row.names = FALSE)
write.csv(SatQCodes,"DischargeCodes_Landsat7_AllReturns.csv",row.names = FALSE)
